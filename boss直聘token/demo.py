...
def clean_variable():
    """替换变量,提高可读性"""
    with open(r'新版分析20200904/bc3c0f5d_source.js', 'r') as f:
        js_str = f.read()

    js_clean_str = ''.join(re.findall(u'(var a=\[.*?;)window\[', js_str))
    ...
    if clean_fun:
        ...
        with open(r'bc3c0f5d_source_clean.js', 'w') as f:
            f.write(js_source)
        print('已全部替换并保存')
...
#     with open(r'bc3c0f5d_source_clean.js', 'r') as f:
#         js_source = f.read()
#
#     windows_text = """
# window = new Object();
...
#     with open(r'bc3c0f5d_source_clean_2.js', 'w') as f:
#         f.write(js_source)


def get_code(seed, ts):
    with open(r'bc3c0f5d_source_clean_2.js', 'r') as f:
        js = f.read()
