...
var document = {
    getElementsByTagName: function (name) {
        if (name == 'link') {
            return [
                {href: "//gw.alicdn.com/tps/i2/TB1nmqyFFXXXXcQbFXXE5jB3XXX-114-114.png"},
                {href: "//gw.alicdn.com/tps/i2/TB1nmqyFFXXXXcQbFXXE5jB3XXX-114-114.png"},
                {href: "https://x.alicdn.com/vip/havana-nlogin/0.5.43/index.css"},
                {href: "https://g.alicdn.com/vip/biz-assets/0.0.8/assets/taobao_pc.css"},
            ]
        }
        ;
        if (name == 'head') {
...
window['location'] = {
    ...
    "href": "https://login.taobao.com/member/login.jhtml?spm=a21bo.2017.754894437.1.5af911d9947IBX&f=top&redirectURL=https%3A%2F%2Fwww.taobao.com%2F",
    "origin": "https://login.taobao.com",
    "pathname": "/member/login.jhtml",
    "port": "",
    "protocol": "https:",
    "search": "?spm=a21bo.2017.754894437.1.5af911d9947IBX&f=top&redirectURL=https%3A%2F%2Fwww.taobao.com%2F",
};
...
window['navigator'] = {
    ...
    appCodeName: "Mozilla",
    appName: "Netscape",
    appVersion: "5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/85.0.4183.102 Safari/537.36",
        ...
        !function (e) {
            ...
            , function (e, t, n) {
                ...
                var s, l, d = "javascript:noCaptcha.reset()",
                    u = "https://survey.taobao.com/survey/QgzQDdDd?token=%TOKEN",
            ...
            , function (module, exports, __webpack_require__) {
                ...
                function makeNoCaptcha(module_nc, opt, inn_vars, nc_events, Scale, onNCEvent, _) {
                    ...
                    var nc_index = inn_vars.index, nc_prefix = inn_vars.prefix, scale_btn = nc_prefix + "n1z",
                        ...
                        clsCheckCode = m_checkcode.init(inn_vars, _, onNCEvent), objCheckCode, tpl = makeTemplate({
                            idx: nc_index,
                            prefix: nc_prefix
                            ...
                            if (e.success) {
                                ...
                                100 == o)
                                    ...
                                    if (util.removeClass(inn_vars.TEXTELEM, "nc-align-center"),
                                        _.id(opt.renderTo).innerHTML = '<div class="errloading"><i class="nc_iconfont icon_warn">' + icon_warn + "</i>" + _upResetIndex(language[opt.language]._error300) + "(error:" + r + ")</div>",
                ...
                var _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (e) {
                    ...
                    default_opt = __webpack_require__(22).default_opt, report2 = __webpack_require__(6),
                    css = __webpack_require__(109), ver = __webpack_require__(5), MAX_ERR_TIME = 3,
            ...
            , function (e, t, n) {
                ...
                function o(e, t, n) {
                    ...
                    a = s.mix(a, e.apimap),
                        ...
                        s.loadScript(s.addHourStamp(a.awsc_Url), function (e) {
                            if (AWSC) {
                                var t = function () {
                                    if (window.__sc__uab) {
                                        if (clearInterval(n),
...
console.log('UA_Opt: ', window.UA_Opt);
